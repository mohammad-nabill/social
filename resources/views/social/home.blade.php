...
{!! Form::open([ 'style'=>'margin-top:50px;' , 'files'=>true ]) !!}


{!! Form::label('write some thing : ') !!}<br> {!! Form::textarea('subject') !!} {{ $errors->first('subject') }}<br>
{!! Form::label('upload photo : ') !!} {!! Form::file('file') !!} {{ $errors->first('file') }}<br>


{!! Form::submit('post') !!} <span style='color:red;'>{{ session()->get('errore') }}</span>
